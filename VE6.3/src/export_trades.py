...
def export(data_dir: str, out_path: str, clear_after: bool = False) -> None:
    ...
    for t in entry_records:
        ...
        row: dict = {
            ...
            "entry_total_contracts": t.get("total_contracts") or t.get("k_contracts_filled", ""),
            "entry_total_cost":      t.get("total_cost", ""),
            "entry_fee":             t.get("fee") or round((t.get("k_actual_fee", 0) or 0) + (t.get("p_actual_fee", 0) or 0), 5) or "",
            "entry_edge_pct":        t.get("edge_pct", ""),
            "entry_total_profit":    t.get("total_profit", ""),
            "entry_arr":             t.get("arr", ""),
            "legs_filled":           t.get("legs_filled", ""),
            "k_contracts_filled":    t.get("k_contracts_filled", ""),
            "p_contracts_filled":    t.get("p_contracts_filled", ""),
            "k_actual_price":        t.get("k_actual_price", ""),
            "p_actual_price":        t.get("p_actual_price", ""),
            "k_actual_cost":         t.get("k_actual_cost", ""),
            "k_actual_fee":          t.get("k_actual_fee", ""),
            "p_actual_cost":         t.get("p_actual_cost", ""),
            "p_actual_fee":          t.get("p_actual_fee", ""),
            "profit_if_kalshi_wins": t.get("profit_if_kalshi_wins", ""),
            "profit_if_poly_wins":   t.get("profit_if_poly_wins", ""),
        }
