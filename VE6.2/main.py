"""VE6.2 CLI entry point — Kalshi × Polymarket cross-market arbitrage bot (live execution only).
...
Requires live credentials in api-keys.json — no paper mode fallback.
"""
...
def _print_banner(cfg: dict, pair_count: int) -> None:
    ...
    color = Fore.GREEN
    print(f"  {Style.BRIGHT}VE6.2 Arbitrage Bot (Live){Style.RESET_ALL}")
